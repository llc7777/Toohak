...
describe('/v1/admin/quiz/:quizId/session/:sessionId/results', () => {
  ...
  describe('Error cases', () => {
    test('Invalid token should return 401 error', () => {
      ...
      const res = getSessionResults(quizId, sessionId, encodedInvalid);
    ...
    test('Empty token returns 401', () => {
      const emptyToken = '';
      const res = getSessionResults(quizId, sessionId, emptyToken);
    ...
    test('User does not own the quiz', () => {
      const res = getSessionResults(quizId, sessionId, nonOwnerToken);
    ...
    test('Quiz does not exist returns 403', () => {
      ...
      const res = getSessionResults(invalidQuizId, sessionId, token);
    ...
    test('Session does not exist returns 400', () => {
      ...
      const res = getSessionResults(quizId, invalidSessionId, token);
