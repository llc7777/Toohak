...
describe('Test for correct return value', () => {
    ...
    test('Should return empty object', () => {
        let user = adminAuthRegister('leo.kim@gmail.com', 'password1', 'Hayden', 'Smith');
        let quiz = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a quiz');
        let result = adminQuizDescriptionUpdate(user.authUserId, quiz.quizId, 'This is a new quiz');
    ...
    test('Should update the empty description', () => {
        let user = adminAuthRegister('leo.kim@gmail.com', 'password1', 'Hayden', 'Smith');
        let quiz = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a new quiz');
    ...
    test('Should update multiple quizzes', () => {
        let user = adminAuthRegister('leo.kim@gmail.com', 'password1', 'Hayden', 'Smith');
        let quiz1 = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a quiz');
        let quiz2 = adminQuizCreate(user.authUserId, 'Quiz 2', 'This is a quiz');
...
describe('Test for error handling', () => {
    ...
    test('Should return error with invalid quiz owner', () => {
        let user = adminAuthRegister('leo.kim@gmail.com', 'password1', 'Hayden', 'Smith');
        let user2 = adminAuthRegister('w@gmail', 'password1', 'John', 'Doe');
        let quiz = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a quiz');
        let quiz2 = adminQuizCreate(user2.authUserId, 'Quiz 2', 'This is a quiz');
