...
describe('Test for correct return value', () => {
    ...
    test('Should return empty object', () => {
        const user = adminAuthRegister('q@gmail', 'password', 'Hayden', 'Smith');
        const quiz = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a quiz');
        expect(adminQuizDescriptionUpdate(user.authUserId, quiz.quizId, 'This is a new quiz')).toStrictEqual({});
    });
...
describe('Test for error handling', () => {
    ...
    test('Should return error with invalid quiz owner', () => {
        const user = adminAuthRegister('q@gmail', 'password', 'Hayden', 'Smith');
        const user2 = adminAuthRegister('w@gmail', 'password', 'John', 'Doe');
        const quiz = adminQuizCreate(user.authUserId, 'Quiz 1', 'This is a quiz');
