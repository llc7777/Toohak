...
Maximum 12 hours, but should be around 3 hours most of the time.
...
Have a meeting and try resolve the conflicts online with the other team members present.

4. List the steps a team member does if they get stuck (e.g. stuck debugging).
First they should try and resolve the issues by themselves. Then ask for help on the Ed forum and in the Teams group. Then could make
an online meeting about the problem and try to resolve it together. Then ask the tutor.
...
Work on the issue as a team, and resolve the problem. Address the issue in the reflection for the next iteration. Raise the problem to the team member
and let then know they must improve next time.
